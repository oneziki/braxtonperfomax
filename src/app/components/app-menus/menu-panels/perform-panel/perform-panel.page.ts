...
@Component({
  selector: 'app-perform-panel',
  templateUrl: 'perform-panel.page.html',
  styleUrls: ['perform-panel.page.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PerformPanel implements OnInit, OnDestroy {
  ...
  setPerformUser(user) {
    ...
    if (this._router.url !== '/perform' && this._router.url !== '/activity-summary') {
  ...
  setNotifications() {
    // Get Module
    const pageIndex = this._notificationService.appIconPages.findIndex(x => x['title'] == 'Perform');
