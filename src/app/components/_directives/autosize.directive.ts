...
export class Autosize implements AfterViewInit {
  ...
  @HostListener('window:resize', ['$event.target'])
    onResize(textArea: HTMLTextAreaElement): void {
      ...
      // console.log('onResize(): ', this.el.clientWidth, this._clientWidth);
      this.adjust();
    }
  ...
  ngAfterViewInit(): void {
    ...
    // console.log('ngAfterViewInit(): ', style.height);
    // console.log('ngAfterViewInit(el): ', this.el);
    // console.log('ngAfterViewInit(height): ', this.element.nativeElement.scrollHeight);
  ...
  adjust(): void {
    ...
    this.el.style.height = 'auto';
    this.el.style.height = this.el.scrollHeight + 'px';
    // console.log('adjust(el): ', this.el);
    // console.log('adjust(height): ', this.el.style.height);
  }
